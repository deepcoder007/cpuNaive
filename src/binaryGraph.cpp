...
unsigned long b_hashPAIRI2( pair<int,int> key ) {
    return (key.first*key.second)%INT_MAX; 
}

bool b_equalPAIRI2( pair<int,int> key1, pair<int,int> key2 ) {
...
*/
bool binaryGraph::gAdjacent(int x,int y) {
...
*/
vector<int> binaryGraph::gNeighbors(int x) {
    vector<int> out;
...
/*
    ...
    NOTE: THREAD_SAFE 
*/
inline bool binaryGraph::isVacant(CONF key, int pos) {
...
/*
    ...
    NOTE: THREAD_SAFE
*/
inline CONF binaryGraph::setVac(CONF key,int pos) {
...
/*
    ...
    NOTE: THREAD_SAFE
*/
inline CONF binaryGraph::unsVac(CONF key,int pos) {
...
/*
    ...
    NOTE: THREAD_SAFE
*/
inline int binaryGraph::cntVac(CONF key) {
#ifdef DEBUG
...
/*
    ...
    NOTE: THREAD_SAFE
*/
inline bool binaryGraph::isValid(CONF key) {
...
*/
void binaryGraph::readFromFile(string name) {
   string line;
   int a,b;
...
*/
set<pair<CONF,int> > binaryGraph::getNeighbour(CONF conf) {
...
/*
    ...
    NOTE: THREAD_SAFE
*/
bool binaryGraph::isNeighbour(CONF conf1,CONF conf2) {
...
*/
bool binaryGraph::existPhero(CONF conf) {
    // lock before doing this
    unique_lock<shared_timed_mutex> lck(phero_mutex[conf[0]]);
...
/*
    ...
    NOTE: THREAD_SAFE
*/
void binaryGraph::markVisit(CONF conf) {
...
/*
    ...
    NOTE: THREAD_SAFE
*/
bool binaryGraph::isVisit(CONF conf) {
...
/*
    ...
    NOTE: THREAD_SAFE
*/
bool binaryGraph::isnVisit(int k) {
